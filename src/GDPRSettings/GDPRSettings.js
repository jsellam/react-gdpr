...
export default class GDPRSettings extends Component {
  ...
  componentDidMount() {
    new OverlayScrollbars(document.querySelector('.gdpr-content-wrapper'), {
          ...
          <div className="gdpr-container">
            ...
            <div className="gdpr-content-wrapper os-host-flexbox">
              <div className="gdpr-content">
                <div className="gdpr-description">
                  {this.props.locale.gdpr_description}
                </div>
                {this.props.content.map(props => (
                  <GDPRSection
            ...
            <div className="gdpr-footer">
              <div
                ...
                className="gdpr-button gdpr-button-accept"
              >
                {this.props.locale.gdpr_validate}
              </div>
              <div
                onClick={this.handleClickCancel}
                className="gdpr-button gdpr-button-cancel"
              >
                {this.props.locale.gdpr_cancel}
              </div>
            </div>
          </div>
        </div>
